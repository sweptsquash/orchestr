 ...
 * Example: Post has many Comments (where Comment belongs to many types)
 */
...
export class MorphMany<TRelated extends Ensemble, TParent extends Ensemble> extends Relation<TRelated, TParent> {
  /**
